...
#define FIREBASE_HOST "mkr1010wifi.firebaseio.com"
#define FIREBASE_AUTH "29TN73IKj0yKSVxGwlkPDBf16hK0j8EUAevdxhLb"
#define WIFI_SSID "GT TECH_2.4G"
#define WIFI_PASSWORD "4804499325"
...
void setup()
{
  ...
  for (uint8_t i = 0; i < 10; i++)
  {
    ...
    if (Firebase.setInt(firebaseData, path + "/MyInt/MyData" + (i + 1), (i + 1) * 100))
    {
